...
- [x] 12-02: Vendor chunking and audit — manualChunks in vite.config.ts, rollup-plugin-visualizer, CI bundle size warning, before/after audit (completed 2026-03-03)
